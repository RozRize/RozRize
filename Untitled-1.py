{
  ...
  "result": {
    "id": 7196873205,
    "is_bot": True,
    "first_name": "RozRizebot",
    "username": "EducationRozRizebot",
...
class TelegramEcho:
    def __init__(self, TG_KEY: str):
        self.TG_URL = "https://api.telegram.org/bot7196873205:AAEG-Ma5i-0sTMY9pLh1XL97Kh_KfpJIM3s/setWebhook"
        self.TG_KEY = TG_KEY
...
if __name__ == "__main__":
    tg = TelegramEcho("7196873205:AAEG-Ma5i-0sTMY9pLh1XL97Kh_KfpJIM3s")
    tg.run()
